...
Before requesting a new feature, please check the [roadmap](#roadmap). Maybe the
feature you want to request is planned already.
...
Here's a list of features I'm planning on adding in the future. They're roughly ordered by priority,
so features at the top of the list will probably be added next.
